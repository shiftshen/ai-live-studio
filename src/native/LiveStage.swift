...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        window=NSWindow(contentRect:NSRect(x:0,y:0,width:260,height:768),styleMask:[.titled,.closable,.miniaturizable,.resizable,.fullSizeContentView],backing:.buffered,defer:false)
        ...
        window.setFrame(NSRect(x:100,y:100,width:260,height:768),display:true)
        ...
        let panel=NSView(frame:NSRect(x:0,y:0,width:260,height:768))
